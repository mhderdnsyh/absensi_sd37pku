<div class="container-fluid">
    ...
    <h1 class="my-4"><span class="fas fa-tools mr-2"></span>Pengaturan</h1>
    <div class="row mb-4">
        <div class="col-xl-6">
            <div class="card mb-4">
                ...
                <?php if (empty($dataapp['statusSetting'])) : ?>
                    <div class="card-body text-center">
                        ...
                        Silakan Klik Tombol <div class="d-inline font-weight-bold">[Initialize Setting App]</div> Untuk Menginstal Fitur Setting
                    </div>
                <?php else : ?>
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nama_instansi" name="nama_instansi" value="<?= $nameinstansiset = (empty($dataapp['namaInstansi'])) ? '[Nama Instansi Belum Disetting]' : $dataapp['nama_instansi']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="pesan_jumbotron" class="col-sm-4 col-form-label">Pesan Halaman Depan</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="pesan_jumbotron" name="pesan_jumbotron" value="<?= $jumbotronset = (empty($dataapp['jumbotronLeadSet'])) ? '[Ubah Kalimat Pada Teks Ini Disetting Aplikasi]' : $dataapp['jumbotron_lead_set']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="nama_app_absen" class="col-sm-4 col-form-label">Nama Aplikasi Absensi</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nama_app_absen" name="nama_app_absen" value="<?= $nameapp = (empty($dataapp['nama_app_absensi'])) ? 'Absensi Online' : $dataapp['nama_app_absensi']; ?>">           <!-- ini perlu pake camel case? -->
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <img src="<?= (empty($dataapp['logoInstansi'])) ? base_url('assets/img/clock-image.png') : (($dataapp['logoInstansi'] == 'default-logo.png') ? base_url('assets/img/clock-image.png') : base_url('storage/setting/' . $dataapp['logoInstansi'])); ?>" class="img-thumbnail">
                                    </div>
                                    <div class="col-sm-9">
