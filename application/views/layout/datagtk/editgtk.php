...
<input type="hidden" name="id_pegawai_edit" id="id_pegawai_edit" value="<?= $datapegawai['idGtk'] ?>">
<div class="form-group row">
    <label for="nama_pegawai_edit" class="col-sm-4 col-form-label">Nama GTK</label>
    <div class="col-sm-8">
        <input type="text" class="form-control" id="nama_pegawai_edit" name="nama_pegawai_edit" value="<?= $datapegawai['namaLengkap'] ?>">
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    <label for="password_pegawai_edit" class="col-sm-4 col-form-label">Password</label>         <!--Password Pegawai-->
    <div class="col-sm-8">
...
<div class="form-group row">
    <label for="kode_pegawai_edit" class="col-sm-4 col-form-label">Kode GTK</label>
    <div class="col-sm-8">
        <input type="text" class="form-control" id="kode_pegawai_edit" name="kode_pegawai_edit" value="<?= $datapegawai['kodeGtk'] ?>" title="Kode telah otomatis digenerate secara acak pada saat penambahan pegawai" readonly>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <input type="text" class="form-control" id="instansi_pegawai_edit" name="instansi_pegawai_edit" value="<?= $nameinstansiset = (empty($dataapp['namaInstansi'])) ? '[Nama Instansi Belum Disetting]' : $dataapp['namaInstansi']; ?>" data-toggle="tooltip" data-placement="top" title="Untuk mengubah nama instansi ini silakan buka pada bagian setting aplikasi" readonly>
    </div>
</div>
<div class="form-group row">
    <label for="npwp_pegawai_edit" class="col-sm-4 col-form-label">NIP</label>         <!--ganti Nip -->
    <div class="col-sm-8">
        <div class="input-group">
            <input type="text" class="form-control" id="npwp_pegawai_edit" name="npwp_pegawai_edit" value="<?= $datapegawai['nipGtk'] == 'Tidak Ada' ? '' : $datapegawai['nipGtk'] ?>">         <!--coba di db ganti nip aja-->
            <div class="input-group-append">
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <input type="text" class="form-control" id="tempat_lahir_pegawai_edit" name="tempat_lahir_pegawai_edit" value="<?= $datapegawai['tempatLahir'] ?>">
    </div>
</div>
<div class="form-group row">
    <label for="tgl_lahir_pegawai_edit" class="col-sm-4 col-form-label">Tanggal Lahir</label>
    <div class="col-sm-8">
        <input type="date" class="form-control" id="tgl_lahir_pegawai_edit" name="tgl_lahir_pegawai_edit" value="<?= $datapegawai['tglLahir'] ?>">
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <div class="form-check form-check-inline">
            <?= form_radio('jenis_kelamin_pegawai_edit', 'Laki - Laki', set_value('jenis_kelamin_pegawai_edit[]', ($datapegawai['jenisKelamin'] == "Laki - Laki") ? true : false), 'id="jenis_kelamin_pegawai_edit" class="form-check-input"'); ?>
            <label class="form-check-label" for="jenis_kelamin_pegawai_edit1">Laki - Laki</label>
        </div>
        <div class="form-check form-check-inline">
            <?= form_radio('jenis_kelamin_pegawai_edit', 'Perempuan', set_value('jenis_kelamin_pegawai_edit[]', ($datapegawai['jenisKelamin'] == "Perempuan") ? true : false), 'class="form-check-input"'); ?>
...
<div class="form-group row">
    <label for="verifikasi_pegawai_edit" class="col-sm-4 col-form-label">Verifikasi GTK</label>
    <div class="col-sm-8">
        <div class="form-check form-check-inline">
            <?= form_radio('verifikasi_pegawai_edit', 0, set_value('verifikasi_pegawai_edit[]', ($datapegawai['isActive'] == 0) ? true : false), 'id="verifikasi_pegawai_edit" class="form-check-input"'); ?>
            <label class="form-check-label" for="verifikasi_pegawai_edit1">Belum Terverifikasi</label>
        </div>
        <div class="form-check form-check-inline">
            <?= form_radio('verifikasi_pegawai_edit', 1, set_value('verifikasi_pegawai_edit[]', ($datapegawai['isActive'] == 1) ? true : false), 'class="form-check-input"'); ?>
